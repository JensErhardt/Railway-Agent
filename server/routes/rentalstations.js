...
router.get('/:id', (req, res, next) => {
  ...
  let hhStart = Number(addZero(today.getHours())) + 1;
  ...
  res.json(`https://api.deutschebahn.com/flinkster-api-ng/v1/bookingproposals?lat=${longitude}&lon=${latitude}&radius=500&offset=5&limit=50&providernetwork=1&begin=${yyyy}-${mm}-${dd}T${hhStart}%3A07%3A00%2B02%3A00&end=${yyyy}-${mm}-${dd}T${hhEnd}%3A10%3A00%2B02%3A00`)
